...
const SYSTEM_PROMPT = [
	...
	"      inline editing. Double-click any Title or Estimate cell to",
	"      edit it, or click the 'Edit' toggle in the toolbar to put",
	"      every row into edit mode at once and tab through the cells.",
	"      A 'Group' toggle next to Edit nests rows by their dotted key.",
	...
	"      stretched durations. The sheet shows total PD, daily capacity, and",
	"      the floor finish (total/capacity) as a live readout.",
