...
const SYSTEM_PROMPT = [
	...
	"  in place — and the same action is on each project card on the workspace",
	"  home (`/`) via a '⋯' menu, where the description also shows as a muted",
	"  second line under the title. Branches show up in the sidebar grouped under their parent",
