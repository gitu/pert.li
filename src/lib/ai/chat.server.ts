...
const SYSTEM_PROMPT = [
	...
	"  Sets a project start date and which weekdays count as working (default",
	"  Mon–Fri). Schedule offsets are rendered as real calendar dates everywhere",
	"  (task inspector, timeline header, Monte Carlo P50/P90 dates).",
	"",
	...
	"  both powered by Better Auth). New users land on the workspace home",
	"  and see a Tutorial card until they have 3+ projects.",
	"",
